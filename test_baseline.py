...
model_path = './baseline_weights.h5'
optimizer = SGD(learning_rate=0.1)
img_width = 64
img_height = 128
batch_size = 32
query_dir = '/data/PersonReID/market1501//query'
gallery_dir = '/data/PersonReID/market1501/bounding_box_test'
...
def main():
    ...
    model_extract_features.compile(loss='categorical_crossentropy', optimizer=optimizer, metrics=['accuracy'])
